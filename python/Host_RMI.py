...
class ControlStationPanel(QWidget):
    ...
    def init_ui(self):
        ...
        self.btn_open = QPushButton("CLOSE Valve (RMCMD_ENABLE_1)")
        self.btn_close = QPushButton("OPEN Valve (RMCMD_DISABLE_1)")
        self.btn_open.setStyleSheet("background-color: #FFB6C1;") #FFB6C1
        self.btn_close.setStyleSheet("background-color: #90EE90;") #90EE90
